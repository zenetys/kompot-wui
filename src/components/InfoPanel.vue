        ...
        <v-card outlined :height="panelInfoHeight" style="overflow: hidden" class="info-panel-card px-1">
            ...
            >
                <v-btn
                    icon
                    class="ml-3"
                    style="position: absolute; right: 0; top: 0; z-index: 32"
                    @click="setInfoEvent()"
                >
                ...
                <div class="three-dots">
                    <span style="font-size: 30px" :title="elements[0].name.split('.')[0]">
                        {{ elements[0].name.split('.')[0] }}
                    </span>
                ...
                <div>
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <v-chip x-small label> Output </v-chip>
                                </td>
                                <td>
                                    <div
                                        class="text-caption three-dots"
                                        style="width: 300px"
                                        :title="elements[0]['plugin_output']"
                                    >
                            ...
                            <tr>
                                <td>
                                    <v-chip x-small label> Sla </v-chip>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <v-chip x-small label> Email </v-chip>
                                </td>
                                <td>
                                    <div class="text-caption three-dots" style="width: 300px">
                            ...
                            <tr>
                                <td>
                                    <v-chip x-small label> Phone </v-chip>
                                </td>
                                <td>
                                    <div class="text-caption three-dots" style="width: 300px">
            ...
            <div style="overflow-y:scroll;height:250px;">
                ...
                >
                    ...
                    <span :title="item.plugin_output">{{ item.plugin_output }}</span>
                </v-alert>
            </div>
        </v-card>
    </div>
...
export default {
    ...
    methods: {
        ...
        getRowStateColor(item) {
            if (item.state == 0 && (item.indicator == '' || item.indicator != '')) return 'green lighten-4';
            if (item.state == 1 && (item.indicator == '' || item.indicator != '')) return 'blue lighten-4';
            if (item.state == 2 && (item.indicator == '' || item.indicator != '')) return 'yellow lighten-4';
            if (item.state == 3 && (item.indicator == '' || item.indicator != '')) return 'red lighten-4';
        },
        toggleInfoPanel() {
